...
public class DatasetListPage extends CompositeWithUsername {
    ...
    static final String EDIT_METADATA_TEXT = "Edit Metadata";
    private static final String EDIT_METADATA_HOVER_HELP =
    ...
    DatasetListPage() {
        ...
        metadataButton.setText(EDIT_METADATA_TEXT);
        metadataButton.setTitle(EDIT_METADATA_HOVER_HELP);
    ...
    void omeOnClick(ClickEvent event) {
        ...
        // Until the METADATA is in place, only accept one cruise
        if ( datasetsSet.size() > 1 ) {
            UploadDashboard.showMessage(
     ...
     * At this time this only checks that an XML metadata document or an additional document is associated with
     * each cruise.
     * <p>
