...
public class OmeManagerPage extends CompositeWithUsername {
    ...
    private static final String CRUISE_HTML_INTRO_PROLOGUE = "<p>" +
            ...
            "<a href='https://data.pmel.noaa.gov/socat/SocatMetadata/MetadataEditor.html' target='_blank'>https://data.pmel.noaa.gov/socat/SocatMetadata/MetadataEditor.html</a>" +
            "</p>" +
            "<p>" +
...
//
// There is no longer a metadata template link on that page, since we are not encouraging that.
// The direct link: https://socat.info/wp-content/uploads/2020/12/Metadata_template-example-for-SOCAT.xlsx
// 
            "</p>" +
            "<p>" +
            "Dataset: <ul><li>";
